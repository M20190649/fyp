...
\section{Trip delay average per hour evaluation}
...
%TODO - check trip delay model in June and compare with October - compare overall with google api

%TODO - analyze validity of OD matrix to model estimated trip delay by specific routes 
...
%TODO - scaling of results - IMPORTNT - can be taken from linear regression model
